enum CreateTypes {
  ...
  SUBMIT_LIVE_DRAFT = 'SUBMIT_LIVE_DRAFT',
  SUBMIT_LIVE_DRAFT_PENDING = 'SUBMIT_LIVE_DRAFT_PENDING',
  SUBMIT_LIVE_DRAFT_FULFILLED = 'SUBMIT_LIVE_DRAFT_FULFILLED',
  SUBMIT_LIVE_DRAFT_REJECTED = 'SUBMIT_LIVE_DRAFT_REJECTED',
