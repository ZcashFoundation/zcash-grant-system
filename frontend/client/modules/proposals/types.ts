enum proposalTypes {
  ...
  PROPOSAL_REVISIONS_FULFILLED = 'PROPOSAL_REVISIONS_FULFILLED',
  PROPOSAL_REVISIONS_REJECTED = 'PROPOSAL_REVISIONS_REJECTED',
  PROPOSAL_REVISIONS_PENDING = 'PROPOSAL_REVISIONS_PENDING',
