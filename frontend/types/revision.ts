...
export enum REVISION_CHANGE_TYPES {
  ...
  MILESTONE_SET_AMOUNT = 'MILESTONE_SET_AMOUNT',
  MILESTONE_SET_DAYS = 'MILESTONE_SET_DAYS',
  MILESTONE_SET_IMMEDIATE_PAYOUT = 'MILESTONE_SET_IMMEDIATE_PAYOUT',
  MILESTONE_SET_PERCENT = 'MILESTONE_SET_PERCENT',
  MILESTONE_SET_CONTENT = 'MILESTONE_SET_CONTENT',
